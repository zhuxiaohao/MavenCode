...
public class ImageCache extends ImageMemoryCache {
    ...
    private library.service.impl.ImageCache.CompressListener compressListener;

    /** cache folder path which be used when saving images **/
    public static final String DEFAULT_CACHE_FOLDER = new StringBuilder().append(android.os.Environment.getExternalStorageDirectory().getAbsolutePath()).append(java.io.File.separator).append("Trinea").append(java.io.File.separator).append("AndroidCommon").append(java.io.File.separator).append("ImageCache").toString();
    ...
    public ImageCache(int primaryCacheMaxSize, int primaryCacheThreadPoolSize, int secondaryCacheMaxSize, int secondaryCacheThreadPoolSize) {
        ...
        setOnGetDataListener(new OnGetDataListener<String, android.graphics.Bitmap>() {
            ...
            public library.entity.CacheObject<android.graphics.Bitmap> onGetData(String key) {
                try {
                    library.entity.CacheObject<String> object = secondaryCache.get(key);
                    String imagePath = (object == null ? null : object.getData());
                    if (library.util.FileUtils.isFileExist(imagePath)) {
                        if (compressListener != null) {
                            compressSize = compressListener.getCompressSize(imagePath);
                        }
                        android.graphics.Bitmap bm;
                        if (compressSize > 1) {
                            android.graphics.BitmapFactory.Options option = new android.graphics.BitmapFactory.Options();
                            option.inSampleSize = compressSize;
                            bm = android.graphics.BitmapFactory.decodeFile(imagePath, option);
                        } else {
                            bm = android.graphics.BitmapFactory.decodeFile(imagePath);
                        }
                        return (bm == null ? null : new library.entity.CacheObject<android.graphics.Bitmap>(bm));
                    } else {
        ...
        setCacheFullRemoveType(new RemoveTypeUsedCountSmall<android.graphics.Bitmap>());
     ...
     */
    public void setCompressListener(library.service.impl.ImageCache.CompressListener compressListener) {
     ...
     */
    public library.service.impl.ImageCache.CompressListener getCompressListener() {
        return compressListener;
    }
     ...
     */
    public OnGetDataListener<String, android.graphics.Bitmap> getOnGetImageListenerOfPrimaryCache() {
     ...
     */
    public void setOnGetImageListenerOfPrimaryCache(OnGetDataListener<String, android.graphics.Bitmap> onGetImageListener) {
     ...
     * @return
     */
    public library.service.CacheFullRemoveType<String> getCacheFullRemoveTypeOfSecondaryCache() {
     ...
     */
    public void setCacheFullRemoveTypeOfSecondaryCache(library.service.CacheFullRemoveType<String> cacheFullRemoveType) {
