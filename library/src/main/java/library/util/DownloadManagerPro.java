...
public class DownloadManagerPro {
    ...
    private static java.lang.reflect.Method pauseDownload = null;
    private static java.lang.reflect.Method resumeDownload = null;
    ...
    public int getStatusById(long downloadId) {
        return getInt(downloadId, android.app.DownloadManager.COLUMN_STATUS);
    }
    ...
    public int[] getBytesAndStatus(long downloadId) {
        ...
        try {
            ...
            if (c != null && c.moveToFirst()) {
                bytesAndStatus[0] = c.getInt(c.getColumnIndexOrThrow(android.app.DownloadManager.COLUMN_BYTES_DOWNLOADED_SO_FAR));
                bytesAndStatus[1] = c.getInt(c.getColumnIndexOrThrow(android.app.DownloadManager.COLUMN_TOTAL_SIZE_BYTES));
                bytesAndStatus[2] = c.getInt(c.getColumnIndex(android.app.DownloadManager.COLUMN_STATUS));
            }
        } finally {
            if (c != null) {
                c.close();
    ...
    private static void initPauseMethod() {
        ...
        try {
            pauseDownload = android.app.DownloadManager.class.getMethod(METHOD_NAME_PAUSE_DOWNLOAD, long[].class);
        } catch (Exception e) {
    ...
    private static void initResumeMethod() {
        ...
        try {
            resumeDownload = android.app.DownloadManager.class.getMethod(METHOD_NAME_RESUME_DOWNLOAD, long[].class);
        } catch (Exception e) {
            // accept all exception
            e.printStackTrace();
        }
    ...
    public String getFileName(long downloadId) {
        return getString(downloadId, (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.HONEYCOMB ? COLUMN_LOCAL_URI : COLUMN_LOCAL_FILENAME));
    }
    ...
    public String getUri(long downloadId) {
        return getString(downloadId, android.app.DownloadManager.COLUMN_URI);
    }
    ...
    public static class RequestPro extends android.app.DownloadManager.Request {
        ...
        private static java.lang.reflect.Method setNotiClass = null;
        private static java.lang.reflect.Method setNotiExtras = null;

        /**
         * @param uri
         *            the HTTP URI to download.
         */
        public RequestPro(android.net.Uri uri) {
            super(uri);
        }
        ...
        public void setNotiClass(String className) {
            synchronized (this) {
                ...
                if (!isInitNotiClass) {
                    ...
                    try {
                        setNotiClass = android.app.DownloadManager.Request.class.getMethod(METHOD_NAME_SET_NOTI_CLASS, CharSequence.class);
                    } catch (Exception e) {
                        // accept all exception
                        e.printStackTrace();
                    }
        ...
        public void setNotiExtras(String extras) {
            synchronized (this) {
                ...
                if (!isInitNotiExtras) {
                    ...
                    try {
                        setNotiExtras = android.app.DownloadManager.Request.class.getMethod(METHOD_NAME_SET_NOTI_EXTRAS, CharSequence.class);
                    } catch (Exception e) {
                        // accept all exception
                        e.printStackTrace();
                    }
