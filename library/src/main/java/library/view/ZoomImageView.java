 ...
 * Package Name:com.zhuxiaohao.common.view
 * Date:2015-4-10下午5:07:11
...
public class ZoomImageView extends android.view.View {
	 ...
	 * @param canvas
	 */
	private void zoom(android.graphics.Canvas canvas) {
		matrix.reset();
		// 将图片按总缩放比例进行缩放
	 ...
	 * @param canvas
	 */
	private void move(android.graphics.Canvas canvas) {
		matrix.reset();
		// 根据手指移动的距离计算出总偏移值
	 ...
	 * @param canvas
	 */
	private void initBitmap(android.graphics.Canvas canvas) {
	 ...
	 * @return 两个手指之间的距离
	 */
	private double distanceBetweenFingers(android.view.MotionEvent event) {
	 ...
	 * @param event
	 */
	private void centerPointBetweenFingers(android.view.MotionEvent event) {
